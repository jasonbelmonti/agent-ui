...
export declare const signalPalette: {
    ...
    readonly grid: "#2b2b2b";
    readonly muted: "#717171";
    readonly text: "#f5f5f0";
    readonly primary: "#c0fe04";
    readonly primaryDeep: "#86b400";
    readonly fieldPrimary: "#d9ff67";
    readonly fieldInk: "#050505";
    readonly accentViolet: "#9f4dff";
    readonly fieldViolet: "#9f4dff";
